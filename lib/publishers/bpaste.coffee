...
module.exports = class BpastePublisher extends Publisher
  ...
  share: (options) ->
    if not options or not options.lexer or not options.expiry or not options.code
    ...
    options =
      method: 'POST'
      hostname: @target
      headers: @get_https_headers
        'Content-Length': data.length

    console.log 'sending request to bpaste.net:', data, options
